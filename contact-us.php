...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name) || !filter_var($email, FILTER_VALIDATE_EMAIL) || empty($subject) || empty($message)) {
        ...
        $headers = "From: noreply@novetchsa.com\r\n";
...
<head>
    ...
    <title>Contact Us - Novetchsa</title>
...
<body class="bg-white">
    ...
    <header class="bg-white shadow-md sticky top-0 z-50">
        <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
            <a href="index.html" class="text-3xl font-bold gradient-text">NovTechSA</a>
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="index.html#services" class="text-gray-600 hover:text-purple-600">Services</a>
                <a href="#" class="text-gray-600 hover:text-purple-600">Packages</a>
            </div>
            <a href="contactus.php" class="hidden md:block bg-purple-600 text-white px-6 py-2 rounded-full hover:bg-purple-700 transition duration-300">Contact Us</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden">
            <a href="index.html" class="block py-2 px-4 text-sm text-gray-600 hover:bg-purple-100">Home</a>
            <a href="#" class="block py-2 px-4 text-sm text-gray-600 hover:bg-purple-100">About Us</a>
            <a href="index.html#services" class="block py-2 px-4 text-sm text-gray-600 hover:bg-purple-100">Services</a>
            <a href="#" class="block py-2 px-4 text-sm text-gray-600 hover:bg-purple-100">Packages</a>
            <a href="contactus.php" class="block py-2 px-4 text-sm text-white bg-purple-600 hover:bg-purple-700">Contact Us</a>
        </div>
    </header>
    ...
    <main>
        <section class="hero-bg">
            <div class="container mx-auto px-6 py-20 text-center">
                <h1 class="text-4xl md:text-5xl font-extrabold text-gray-800">Get In Touch</h1>
                <p class="mt-4 text-lg text-gray-600">We'd love to hear from you. Fill out the form below to start a conversation.</p>
            </div>
        </section>
        ...
        <section class="py-20">
            <div class="container mx-auto px-6">
                <div class="max-w-3xl mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="bg-white p-8 rounded-lg shadow-lg space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="name" name="name" value="<?php echo htmlspecialchars($name); ?>" required class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:ring-purple-500 focus:border-purple-500" placeholder="John Doe">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($email); ?>" required class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:ring-purple-500 focus:border-purple-500" placeholder="you@example.com">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" id="phone" name="phone" value="<?php echo htmlspecialchars($phone); ?>" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:ring-purple-500 focus:border-purple-500" placeholder="+27 12 345 6789">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 flex items-center pl-3">
                                    <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-5-5h12l-5 5z"></path></svg>
                                </span>
                                <input type="text" id="subject" name="subject" value="<?php echo htmlspecialchars($subject); ?>" required class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:ring-purple-500 focus:border-purple-500" placeholder="e.g., Quote for a Web Project">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" rows="5" required class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-purple-500 focus:border-purple-500" placeholder="Tell us about your project..."><?php echo htmlspecialchars($message); ?></textarea>
                        </div>

                        <!-- Submit Button -->
                        <div>
                            <button type="submit" class="w-full bg-purple-600 text-white px-6 py-3 rounded-md font-semibold hover:bg-purple-700 transition duration-300">Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <footer class="bg-gray-800 text-white">
        <div class="container mx-auto px-6 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-xl font-bold mb-4">NovTechSA</h3>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li class="mb-2"><a href="index.html#services" class="hover:text-purple-400">Services</a></li>
                        <li class="mb-2"><a href="#" class="hover:text-purple-400">Packages</a></li>
                        <li class="mb-2"><a href="contactus.php" class="hover:text-purple-400">Contact</a></li>
                    </ul>
                </div>
                <div>
            ...
            <div class="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
                <p>&copy; <span id="current-year"></span> NovTechSA. All rights reserved.</p>
            </div>
        </div>
    </footer>
